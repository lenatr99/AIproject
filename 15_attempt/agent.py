...
class Agent():
    ...
    def evaluate(self, state):
        ...
        value = self.calculate_edge_max_bonus(state) + self.calculate_open_square_bonus(state) - self.non_monotonic_penalty(state) + self.calculate_merge_count_bonus(state) - self.corner_max_penalty(state)  # Included corner max penalty
        return value
