...
class Game():
    ...
    def __init__(self, size = 4, seed = 42, reward_mode='log2',negative_reward = 0, cell_move_penalty = 0, edge_max_bonus=0.5, open_square_bonus=0.2):
    ...
    def step(self, action, action_values):
        ...
        if not np.array_equal(self.game_board, temp_board):
            ...
            self.reward = self.reward + self.calculate_edge_max_bonus() + self.calculate_open_square_bonus() - self.non_monotonic_penalty() + self.calculate_merge_count_bonus()
